...
var file_messenger_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x30, 0x0a, 0x14, 0x43, 0x72, 0x65,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xa2, 0x01, 0x0a, 0x09, 0x4d, 0x65, 0x73,
	0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x12, 0x45, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x73,
...
var file_messenger_proto_depIdxs = []int32{
	...
	0, // 1: messenger.Messenger.CreateMessage:input_type -> messenger.CreateMessageRequest
...
func (c *messengerClient) CreateMessage(ctx context.Context, in *CreateMessageRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
...
func (*UnimplementedMessengerServer) CreateMessage(context.Context, *CreateMessageRequest) (*MessageResponse, error) {
